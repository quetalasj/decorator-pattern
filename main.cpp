...
//
//int main() {
//    shared_ptr<Beverage> beverage = make_shared<Beverage>(Expresso());
//    cout << beverage->getDescription() << " $" << beverage->cost() << endl;
//
//    shared_ptr<Beverage> beverage2 = make_shared<Beverage>(HouseBlend());
//    cout << beverage2->getDescription() << " $" << beverage2->cost() << endl;
//
//    Mocha mocha = Mocha(beverage);
////    shared_ptr<Beverage> decorated_beverage = make_shared<Beverage>(mocha);
//    Beverage* decorated_beverage = &mocha;
////    shared_ptr<Beverage> decorated_beverage2 = make_shared<Beverage>(Mocha(beverage2));
//    cout << mocha.getDescription() << " $" << mocha.cost() << endl;
//    cout << decorated_beverage->getDescription() << " $" << decorated_beverage->cost() << endl;
//    return 0;
//}
//
/**
